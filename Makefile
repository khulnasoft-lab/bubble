...
bootstrap-tools: $(TEMP_DIR)
	...
	curl -sSfL https://raw.githubusercontent.com/sulaiman-coder/gobouncer/master/bouncer.sh | sh -s -- -b $(TEMP_DIR)/ $(GOBOUNCER_VERSION)
...
unit: $(TEMP_DIR)  ## Run unit tests (with coverage)
	...
	go test -coverprofile $(TEMP_DIR)/unit-coverage-details.txt $(shell go list ./... | grep -v khulnasoft-labs/bubble/test)
